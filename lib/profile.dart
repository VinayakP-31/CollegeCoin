...
class _ProfileScreenState extends State<ProfileScreen> {
        ...
        child: Container(
          ...
          child: Column(
            children: [
              ...
              Stack(
                children: [
                  SizedBox(
                    ...
                    height: 120,
                    child: ClipRRect(
                        borderRadius: BorderRadius.circular(100), child: Image.asset('assets/profile.png')),
                  ),
                  Positioned(
                    bottom: 0,
                    right: 0,
              ...
              Text(user?.email as String, style: const TextStyle(fontSize: 22,fontWeight: FontWeight.normal)),
              ...
              /// -- MENU
              ProfileMenuWidget(title: "Change Password", icon: LineAwesomeIcons.cog, onPress: () {Navigator.of(context).pushNamed('/forgotpass/');}),
              ProfileMenuWidget(title: "Account", icon: LineAwesomeIcons.wallet, onPress: () {Navigator.of(context).pushNamed('/wallet/');}),
              ProfileMenuWidget(title: "Change Limit", icon: LineAwesomeIcons.money_bill, onPress: () {Navigator.of(context).pushNamed('/changewallet/');}),
              const Divider(),
              const SizedBox(height: 10),
              ProfileMenuWidget(
                  title: "Logout",
  ...
  String getName(User? user){
    String s;
    if(user?.email=="vinayakprasad1729@gmail.com"){
       s="Vinayak Prasad"; 
